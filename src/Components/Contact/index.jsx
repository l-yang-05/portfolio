            ...
            <div className="form-wrapper">
                <fieldset>
                    <form form-name="contact-me" onSubmit={handleSubmit(onSubmit)} method="POST" data-netlify="true">
                        ...
                        <input type="text" placeholder="Full Name" onChange={handleChange} name="full_name" id="fname" value={state.fullName} ref={register({ required: true, min: 5, pattern: /^[a-zA-z']([^0-9]*)$/ })} />
                        ...
                        <input type="text" placeholder="Email address" onChange={handleChange} name="email" id="mail" value={state.email} ref={register({ required: true, pattern: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/ })} />
                        <p className="error-msg">{errors.email && 'Please enter in a vaild email address!'}</p>

                        <label htmlFor="msg">Message</label>
                        <textarea name="message" placeholder="Write your message in here!" id="msg" onChange={handleChange} value={state.message} ref={register({ required: true, min: 2, max: 1000, maxLength: 200 })}></textarea>
